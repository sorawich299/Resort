    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white rounded-lg shadow-lg w-full max-w-2xl p-6 relative">
        ...
        <div className="max-h-[400px] overflow-y-auto space-y-4 text-gray-700">
          ...
          <p>
            1. Controller for data processing The controller for data processing on this website pursuant to Article 4 No 7 GDPR and the provider of the website (service provider) is Solunar. 129 moo 2 Bang Sare, Sattahip, Chon Buri 20250 Thailand E-mail: info@solunarvilla.com Contact details of the Data Protection Officer You can reach our Data Protection Officer at Solunar. 129 moo 2 Bang Sare, Sattahip, Chon Buri 20250 Thailand E-mail: info@solunarvilla.com
          </p>
          <p>
