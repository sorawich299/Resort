...
export default function Footer() {
  ...
  const [isOpenTermsOfService, setIsOpenTermsOfService] =
    useState<boolean>(false);
  ...
  return (
    ...
    >
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="flex items-center gap-4">
              <div className="flex items-center gap-2">
                ...
                <a href="mailto:info@solunarvilla.com">info@solunarvilla.com</a>
              </div>
              <div className="flex items-center gap-2">
        ...
        <div className="flex flex-col gap-8">
          ...
          <div className="flex flex-col sm:flex-row justify-between items-center text-sm">
            ...
            <div className="flex gap-4 mt-2 sm:mt-0">
              <button
                onClick={() => setIsOpenPrivacyPolicy(!isOpenPrivacyPolicy)}
                className="underline cursor-pointer"
              >
                Privacy Policy
              </button>
              <button
                onClick={() => setIsOpenTermsOfService(!isOpenTermsOfService)}
                className="underline cursor-pointer"
              >
                Terms of Service
              </button>
      ...
      <PrivacyPolicyModal
        ...
        onClose={() => setIsOpenPrivacyPolicy(!isOpenPrivacyPolicy)}
      ></PrivacyPolicyModal>
      <ModalTermsOfService
        isOpen={isOpenTermsOfService}
        onClose={() => setIsOpenTermsOfService(!isOpenTermsOfService)}
      ></ModalTermsOfService>
    </footer>
  );
}
